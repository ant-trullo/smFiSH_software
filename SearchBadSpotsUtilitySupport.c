...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "SearchBadSpotsUtilitySupport",
        "sources": [
            "SearchBadSpotsUtilitySupport.pyx"
        ]
    },
    "module_name": "SearchBadSpotsUtilitySupport"
}
END: Cython Metadata */
...
#define __PYX_HAVE__SearchBadSpotsUtilitySupport
#define __PYX_HAVE_API__SearchBadSpotsUtilitySupport
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* "SearchBadSpotsUtilitySupport.pyx":7
 * 
 * DTYPE = np.int32
 ...
 * 
 */
typedef __pyx_t_5numpy_int32_t __pyx_t_28SearchBadSpotsUtilitySupport_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'SearchBadSpotsUtilitySupport' */
static PyObject *__pyx_f_28SearchBadSpotsUtilitySupport_unique_cython_int_1dim(PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_28SearchBadSpotsUtilitySupport_SearchBadSpotsUtilitySupport(PyArrayObject *, PyObject *, PyObject *, PyObject *, int, int, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_28SearchBadSpotsUtilitySupport_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_28SearchBadSpotsUtilitySupport_DTYPE_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_28SearchBadSpotsUtilitySupport_DTYPE_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_28SearchBadSpotsUtilitySupport_DTYPE_t), 0 };
#define __Pyx_MODULE_NAME "SearchBadSpotsUtilitySupport"
int __pyx_module_is_main_SearchBadSpotsUtilitySupport = 0;

/* Implementation of 'SearchBadSpotsUtilitySupport' */
...
static const char __pyx_k_num_frms[] = "num_frms";
...
static PyObject *__pyx_n_s_num_frms;
...
static PyObject *__pyx_pf_28SearchBadSpotsUtilitySupport_unique_cython_int_1dim(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_a); /* proto */
static PyObject *__pyx_pf_28SearchBadSpotsUtilitySupport_2SearchBadSpotsUtilitySupport(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_a, PyObject *__pyx_v_l, PyObject *__pyx_v_v, PyObject *__pyx_v_c, int __pyx_v_vol, int __pyx_v_num_frms); /* proto */
...
/* "SearchBadSpotsUtilitySupport.pyx":10
 * 
 * 
...
static PyObject *__pyx_pw_28SearchBadSpotsUtilitySupport_1unique_cython_int_1dim(PyObject *__pyx_self, PyObject *__pyx_v_a); /*proto*/
static PyObject *__pyx_f_28SearchBadSpotsUtilitySupport_unique_cython_int_1dim(PyArrayObject *__pyx_v_a, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_x;
  int __pyx_v_xlen;
  PyObject *__pyx_v_s = 0;
  PyObject *__pyx_v_s_list = 0;
  PyObject *__pyx_v_s_el = NULL;
  ...
  __Pyx_RefNannySetupContext("unique_cython_int_1dim", 0);
  ...
  __pyx_pybuffernd_a.rcbuffer = &__pyx_pybuffer_a;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_a.rcbuffer->pybuffer, (PyObject*)__pyx_v_a, &__Pyx_TypeInfo_nn___pyx_t_28SearchBadSpotsUtilitySupport_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 10, __pyx_L1_error)
  }
  ...
  /* "SearchBadSpotsUtilitySupport.pyx":12
 * cpdef unique_cython_int_1dim(np.ndarray[DTYPE_t, ndim=1] a):
 *     cdef int x
 *     cdef int xlen = a.size             # <<<<<<<<<<<<<<
 *     cdef set s = set()
 *     cdef list s_list = []
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_a), __pyx_n_s_size); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
  ...
  __pyx_v_xlen = __pyx_t_2;

  /* "SearchBadSpotsUtilitySupport.pyx":13
 *     cdef int x
 *     cdef int xlen = a.size
 *     cdef set s = set()             # <<<<<<<<<<<<<<
 *     cdef list s_list = []
 ...
 */
  ...
  /* "SearchBadSpotsUtilitySupport.pyx":14
 *     cdef int xlen = a.size
 *     cdef set s = set()
 *     cdef list s_list = []             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_s_list = ((PyObject*)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "SearchBadSpotsUtilitySupport.pyx":16
 *     cdef list s_list = []
 * 
 *     for x in range(xlen):             # <<<<<<<<<<<<<<
 *         s.add(a[x])
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "SearchBadSpotsUtilitySupport.pyx":17
 * 
 *     for x in range(xlen):
 *         s.add(a[x])             # <<<<<<<<<<<<<<
 *     for s_el in s:
 ...
 */
    ...
    __pyx_t_1 = __Pyx_PyInt_From_npy_int32((*__Pyx_BufPtrStrided1d(__pyx_t_28SearchBadSpotsUtilitySupport_DTYPE_t *, __pyx_pybuffernd_a.rcbuffer->pybuffer.buf, __pyx_t_4, __pyx_pybuffernd_a.diminfo[0].strides))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_6 = PySet_Add(__pyx_v_s, __pyx_t_1); if (unlikely(__pyx_t_6 == -1)) __PYX_ERR(0, 17, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  }

  /* "SearchBadSpotsUtilitySupport.pyx":18
 *     for x in range(xlen):
 *         s.add(a[x])
 *     for s_el in s:             # <<<<<<<<<<<<<<
 *         s_list.append(s_el)
 * 
 */
  __pyx_t_1 = PyObject_GetIter(__pyx_v_s); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  for (;;) {
    ...
    __Pyx_XDECREF_SET(__pyx_v_s_el, __pyx_t_8);
    __pyx_t_8 = 0;

    /* "SearchBadSpotsUtilitySupport.pyx":19
 *         s.add(a[x])
 *     for s_el in s:
 *         s_list.append(s_el)             # <<<<<<<<<<<<<<
 * 
 *     return s_list
 */
    __pyx_t_6 = __Pyx_PyList_Append(__pyx_v_s_list, __pyx_v_s_el); if (unlikely(__pyx_t_6 == -1)) __PYX_ERR(0, 19, __pyx_L1_error)
 ...
 */
  ...
  /* "SearchBadSpotsUtilitySupport.pyx":21
 *         s_list.append(s_el)
 * 
 *     return s_list             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_INCREF(__pyx_v_s_list);
  __pyx_r = __pyx_v_s_list;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("SearchBadSpotsUtilitySupport.unique_cython_int_1dim", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_a.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_28SearchBadSpotsUtilitySupport_1unique_cython_int_1dim(PyObject *__pyx_self, PyObject *__pyx_v_a); /*proto*/
static PyObject *__pyx_pw_28SearchBadSpotsUtilitySupport_1unique_cython_int_1dim(PyObject *__pyx_self, PyObject *__pyx_v_a) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("unique_cython_int_1dim (wrapper)", 0);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_a), __pyx_ptype_5numpy_ndarray, 1, "a", 0))) __PYX_ERR(0, 10, __pyx_L1_error)
  __pyx_r = __pyx_pf_28SearchBadSpotsUtilitySupport_unique_cython_int_1dim(__pyx_self, ((PyArrayObject *)__pyx_v_a));
...
static PyObject *__pyx_pf_28SearchBadSpotsUtilitySupport_unique_cython_int_1dim(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_a) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_a;
  __Pyx_Buffer __pyx_pybuffer_a;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_pybuffernd_a.diminfo[0].strides = __pyx_pybuffernd_a.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_a.diminfo[0].shape = __pyx_pybuffernd_a.rcbuffer->pybuffer.shape[0];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_28SearchBadSpotsUtilitySupport_unique_cython_int_1dim(__pyx_v_a, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "SearchBadSpotsUtilitySupport.pyx":26
 * 
...
static PyObject *__pyx_pw_28SearchBadSpotsUtilitySupport_3SearchBadSpotsUtilitySupport(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_28SearchBadSpotsUtilitySupport_SearchBadSpotsUtilitySupport(PyArrayObject *__pyx_v_a, PyObject *__pyx_v_l, PyObject *__pyx_v_v, PyObject *__pyx_v_c, int __pyx_v_vol, int __pyx_v_num_frms, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_len_b;
  int __pyx_v_zlen;
  int __pyx_v_xlen;
  int __pyx_v_ylen;
  int __pyx_v_tag_ref;
  PyArrayObject *__pyx_v_msk = 0;
  int __pyx_v_j;
  int __pyx_v_z;
  int __pyx_v_x;
  int __pyx_v_y;
  ...
  int __pyx_t_20;
  __Pyx_RefNannySetupContext("SearchBadSpotsUtilitySupport", 0);
  __pyx_pybuffer_a.pybuffer.buf = NULL;
  __pyx_pybuffer_a.refcount = 0;
  __pyx_pybuffernd_a.data = NULL;
  __pyx_pybuffernd_a.rcbuffer = &__pyx_pybuffer_a;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_a.rcbuffer->pybuffer, (PyObject*)__pyx_v_a, &__Pyx_TypeInfo_nn___pyx_t_28SearchBadSpotsUtilitySupport_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 26, __pyx_L1_error)
  }
  ...
  /* "SearchBadSpotsUtilitySupport.pyx":27
 * #cpdef SearchBadSpotsUtilitySupport(np.ndarray[long long, ndim=3] a, list l, list v, list c, int vol, int num_frms):
 * cpdef SearchBadSpotsUtilitySupport(np.ndarray[DTYPE_t, ndim=3] a, list l, list v, list c, int vol, int num_frms):
 *     cdef int len_b  =  len(l)             # <<<<<<<<<<<<<<
 *     cdef int zlen   =  a.shape[0]
 ...
 */
  ...
  __pyx_t_1 = PyList_GET_SIZE(__pyx_v_l); if (unlikely(__pyx_t_1 == -1)) __PYX_ERR(0, 27, __pyx_L1_error)
  __pyx_v_len_b = __pyx_t_1;

  /* "SearchBadSpotsUtilitySupport.pyx":28
 * cpdef SearchBadSpotsUtilitySupport(np.ndarray[DTYPE_t, ndim=3] a, list l, list v, list c, int vol, int num_frms):
 *     cdef int len_b  =  len(l)
 *     cdef int zlen   =  a.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int xlen   =  a.shape[1]
 ...
 */
  __pyx_v_zlen = (__pyx_v_a->dimensions[0]);

  /* "SearchBadSpotsUtilitySupport.pyx":29
 *     cdef int len_b  =  len(l)
 *     cdef int zlen   =  a.shape[0]
 *     cdef int xlen   =  a.shape[1]             # <<<<<<<<<<<<<<
 *     cdef int ylen   =  a.shape[2]
 *     cdef int tag_ref
 */
  __pyx_v_xlen = (__pyx_v_a->dimensions[1]);

  /* "SearchBadSpotsUtilitySupport.pyx":30
 *     cdef int zlen   =  a.shape[0]
 *     cdef int xlen   =  a.shape[1]
 *     cdef int ylen   =  a.shape[2]             # <<<<<<<<<<<<<<
 *     cdef int tag_ref
 ...
 */
  __pyx_v_ylen = (__pyx_v_a->dimensions[2]);

  /* "SearchBadSpotsUtilitySupport.pyx":32
 *     cdef int ylen   =  a.shape[2]
 *     cdef int tag_ref
 *     cdef np.ndarray msk = np.zeros([zlen, xlen, ylen], dtype=DTYPE)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_zlen); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_xlen); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_ylen); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 32, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_DTYPE); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __pyx_v_msk = ((PyArrayObject *)__pyx_t_4);
  __pyx_t_4 = 0;

  /* "SearchBadSpotsUtilitySupport.pyx":34
 *     cdef np.ndarray msk = np.zeros([zlen, xlen, ylen], dtype=DTYPE)
 * 
 *     for j in range(len_b):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    ...
    /* "SearchBadSpotsUtilitySupport.pyx":35
 * 
 *     for j in range(len_b):
 *         if v[j] < vol or len(unique_cython_int_1dim(c[j])) < num_frms:      # the constrain on the coordinates asks to a spots to be 3D, not 2D             # <<<<<<<<<<<<<<
 * #            print(v[j])
 ...
 */
    ...
    __pyx_t_4 = __Pyx_GetItemInt_List(__pyx_v_v, __pyx_v_j, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 35, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_vol); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 35, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_5 = PyObject_RichCompare(__pyx_t_4, __pyx_t_6, Py_LT); __Pyx_XGOTREF(__pyx_t_5); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 35, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    ...
    __pyx_t_5 = __Pyx_GetItemInt_List(__pyx_v_c, __pyx_v_j, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 35, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    if (!(likely(((__pyx_t_5) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_5, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 35, __pyx_L1_error)
    __pyx_t_6 = __pyx_f_28SearchBadSpotsUtilitySupport_unique_cython_int_1dim(((PyArrayObject *)__pyx_t_5), 0); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 35, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_1 = PyObject_Length(__pyx_t_6); if (unlikely(__pyx_t_1 == -1)) __PYX_ERR(0, 35, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_10 = ((__pyx_t_1 < __pyx_v_num_frms) != 0);
    __pyx_t_9 = __pyx_t_10;
    __pyx_L6_bool_binop_done:;
    if (__pyx_t_9) {

      /* "SearchBadSpotsUtilitySupport.pyx":37
 *         if v[j] < vol or len(unique_cython_int_1dim(c[j])) < num_frms:      # the constrain on the coordinates asks to a spots to be 3D, not 2D
 * #            print(v[j])
 *             tag_ref  =  l[j]             # <<<<<<<<<<<<<<
 *             for z in range(zlen):
 ...
 */
      ...
      __pyx_t_6 = __Pyx_GetItemInt_List(__pyx_v_l, __pyx_v_j, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_11 = __Pyx_PyInt_As_int(__pyx_t_6); if (unlikely((__pyx_t_11 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_v_tag_ref = __pyx_t_11;

      /* "SearchBadSpotsUtilitySupport.pyx":38
 * #            print(v[j])
 *             tag_ref  =  l[j]
 *             for z in range(zlen):             # <<<<<<<<<<<<<<
 *                 for x in range(xlen):
 *                     for y in range(ylen):
 */
      __pyx_t_11 = __pyx_v_zlen;
      for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
        __pyx_v_z = __pyx_t_12;

        /* "SearchBadSpotsUtilitySupport.pyx":39
 *             tag_ref  =  l[j]
 *             for z in range(zlen):
 *                 for x in range(xlen):             # <<<<<<<<<<<<<<
 *                     for y in range(ylen):
 *                         if a[z, x, y] == tag_ref:
 */
        __pyx_t_13 = __pyx_v_xlen;
        for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
          __pyx_v_x = __pyx_t_14;

          /* "SearchBadSpotsUtilitySupport.pyx":40
 *             for z in range(zlen):
 *                 for x in range(xlen):
 *                     for y in range(ylen):             # <<<<<<<<<<<<<<
 *                         if a[z, x, y] == tag_ref:
 ...
 */
          ...
          for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
            ...
            /* "SearchBadSpotsUtilitySupport.pyx":41
 *                 for x in range(xlen):
 *                     for y in range(ylen):
 *                         if a[z, x, y] == tag_ref:             # <<<<<<<<<<<<<<
 *                             msk[z, x, y]  +=  1
 ...
 */
            ...
            } else if (unlikely(__pyx_t_17 >= __pyx_pybuffernd_a.diminfo[0].shape)) __pyx_t_20 = 0;
            if (__pyx_t_18 < 0) {
              __pyx_t_18 += __pyx_pybuffernd_a.diminfo[1].shape;
              if (unlikely(__pyx_t_18 < 0)) __pyx_t_20 = 1;
            } else if (unlikely(__pyx_t_18 >= __pyx_pybuffernd_a.diminfo[1].shape)) __pyx_t_20 = 1;
            if (__pyx_t_19 < 0) {
              __pyx_t_19 += __pyx_pybuffernd_a.diminfo[2].shape;
              if (unlikely(__pyx_t_19 < 0)) __pyx_t_20 = 2;
            } else if (unlikely(__pyx_t_19 >= __pyx_pybuffernd_a.diminfo[2].shape)) __pyx_t_20 = 2;
            if (unlikely(__pyx_t_20 != -1)) {
              __Pyx_RaiseBufferIndexError(__pyx_t_20);
              __PYX_ERR(0, 41, __pyx_L1_error)
            }
            __pyx_t_9 = (((*__Pyx_BufPtrStrided3d(__pyx_t_28SearchBadSpotsUtilitySupport_DTYPE_t *, __pyx_pybuffernd_a.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_a.diminfo[0].strides, __pyx_t_18, __pyx_pybuffernd_a.diminfo[1].strides, __pyx_t_19, __pyx_pybuffernd_a.diminfo[2].strides)) == __pyx_v_tag_ref) != 0);
            if (__pyx_t_9) {

              /* "SearchBadSpotsUtilitySupport.pyx":42
 *                     for y in range(ylen):
 *                         if a[z, x, y] == tag_ref:
 *                             msk[z, x, y]  +=  1             # <<<<<<<<<<<<<<
 * 
 *     return msk
 */
              __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_z); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 42, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_6);
              __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_x); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 42, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_5);
              __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_y); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 42, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_4);
              ...
              __pyx_t_5 = 0;
              __pyx_t_4 = 0;
              __pyx_t_4 = PyObject_GetItem(((PyObject *)__pyx_v_msk), __pyx_t_3); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 42, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_4);
              __pyx_t_5 = __Pyx_PyInt_AddObjC(__pyx_t_4, __pyx_int_1, 1, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 42, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_5);
              __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
              if (unlikely(PyObject_SetItem(((PyObject *)__pyx_v_msk), __pyx_t_3, __pyx_t_5) < 0)) __PYX_ERR(0, 42, __pyx_L1_error)
              __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
              __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  /* "SearchBadSpotsUtilitySupport.pyx":44
 *                             msk[z, x, y]  +=  1
 * 
 *     return msk             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_a.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("SearchBadSpotsUtilitySupport.SearchBadSpotsUtilitySupport", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_a.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_28SearchBadSpotsUtilitySupport_3SearchBadSpotsUtilitySupport(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_28SearchBadSpotsUtilitySupport_3SearchBadSpotsUtilitySupport(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_a = 0;
  PyObject *__pyx_v_l = 0;
  PyObject *__pyx_v_v = 0;
  PyObject *__pyx_v_c = 0;
  int __pyx_v_vol;
  int __pyx_v_num_frms;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("SearchBadSpotsUtilitySupport (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_a,&__pyx_n_s_l,&__pyx_n_s_v,&__pyx_n_s_c,&__pyx_n_s_vol,&__pyx_n_s_num_frms,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_l)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("SearchBadSpotsUtilitySupport", 1, 6, 6, 1); __PYX_ERR(0, 26, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_v)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("SearchBadSpotsUtilitySupport", 1, 6, 6, 2); __PYX_ERR(0, 26, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("SearchBadSpotsUtilitySupport", 1, 6, 6, 3); __PYX_ERR(0, 26, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_vol)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("SearchBadSpotsUtilitySupport", 1, 6, 6, 4); __PYX_ERR(0, 26, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_num_frms)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("SearchBadSpotsUtilitySupport", 1, 6, 6, 5); __PYX_ERR(0, 26, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "SearchBadSpotsUtilitySupport") < 0)) __PYX_ERR(0, 26, __pyx_L3_error)
      }
    ...
    __pyx_v_v = ((PyObject*)values[2]);
    __pyx_v_c = ((PyObject*)values[3]);
    __pyx_v_vol = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_vol == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
    __pyx_v_num_frms = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_num_frms == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("SearchBadSpotsUtilitySupport", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 26, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("SearchBadSpotsUtilitySupport.SearchBadSpotsUtilitySupport", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_l), (&PyList_Type), 1, "l", 1))) __PYX_ERR(0, 26, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_v), (&PyList_Type), 1, "v", 1))) __PYX_ERR(0, 26, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_c), (&PyList_Type), 1, "c", 1))) __PYX_ERR(0, 26, __pyx_L1_error)
  __pyx_r = __pyx_pf_28SearchBadSpotsUtilitySupport_2SearchBadSpotsUtilitySupport(__pyx_self, __pyx_v_a, __pyx_v_l, __pyx_v_v, __pyx_v_c, __pyx_v_vol, __pyx_v_num_frms);
...
static PyObject *__pyx_pf_28SearchBadSpotsUtilitySupport_2SearchBadSpotsUtilitySupport(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_a, PyObject *__pyx_v_l, PyObject *__pyx_v_v, PyObject *__pyx_v_c, int __pyx_v_vol, int __pyx_v_num_frms) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_a;
  __Pyx_Buffer __pyx_pybuffer_a;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_pybuffernd_a.diminfo[0].strides = __pyx_pybuffernd_a.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_a.diminfo[0].shape = __pyx_pybuffernd_a.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_a.diminfo[1].strides = __pyx_pybuffernd_a.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_a.diminfo[1].shape = __pyx_pybuffernd_a.rcbuffer->pybuffer.shape[1]; __pyx_pybuffernd_a.diminfo[2].strides = __pyx_pybuffernd_a.rcbuffer->pybuffer.strides[2]; __pyx_pybuffernd_a.diminfo[2].shape = __pyx_pybuffernd_a.rcbuffer->pybuffer.shape[2];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_28SearchBadSpotsUtilitySupport_SearchBadSpotsUtilitySupport(__pyx_v_a, __pyx_v_l, __pyx_v_v, __pyx_v_c, __pyx_v_vol, __pyx_v_num_frms, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"unique_cython_int_1dim", (PyCFunction)__pyx_pw_28SearchBadSpotsUtilitySupport_1unique_cython_int_1dim, METH_O, 0},
  {"SearchBadSpotsUtilitySupport", (PyCFunction)__pyx_pw_28SearchBadSpotsUtilitySupport_3SearchBadSpotsUtilitySupport, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_num_frms, __pyx_k_num_frms, sizeof(__pyx_k_num_frms), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initSearchBadSpotsUtilitySupport(void); /*proto*/
PyMODINIT_FUNC initSearchBadSpotsUtilitySupport(void)
#else
PyMODINIT_FUNC PyInit_SearchBadSpotsUtilitySupport(void); /*proto*/
PyMODINIT_FUNC PyInit_SearchBadSpotsUtilitySupport(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_SearchBadSpotsUtilitySupport(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("SearchBadSpotsUtilitySupport", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_SearchBadSpotsUtilitySupport) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "SearchBadSpotsUtilitySupport")) {
      if (unlikely(PyDict_SetItemString(modules, "SearchBadSpotsUtilitySupport", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "SearchBadSpotsUtilitySupport.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * #import pyximport
 */
  ...
  /* "SearchBadSpotsUtilitySupport.pyx":6
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init SearchBadSpotsUtilitySupport", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init SearchBadSpotsUtilitySupport");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3

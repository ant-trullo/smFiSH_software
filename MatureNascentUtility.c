...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "MatureNascentUtility",
        "sources": [
            "MatureNascentUtility.pyx"
        ]
    },
    "module_name": "MatureNascentUtility"
}
END: Cython Metadata */
...
#define __PYX_HAVE__MatureNascentUtility
#define __PYX_HAVE_API__MatureNascentUtility
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
 ...
 */
typedef __pyx_t_5numpy_int32_t __pyx_t_20MatureNascentUtility_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'MatureNascentUtility' */
static PyObject *__pyx_f_20MatureNascentUtility_MatureNascentUtility(PyArrayObject *, PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_20MatureNascentUtility_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_20MatureNascentUtility_DTYPE_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_20MatureNascentUtility_DTYPE_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_20MatureNascentUtility_DTYPE_t), 0 };
#define __Pyx_MODULE_NAME "MatureNascentUtility"
int __pyx_module_is_main_MatureNascentUtility = 0;

/* Implementation of 'MatureNascentUtility' */
...
static const char __pyx_k_spts_lbls[] = "spts_lbls";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_spts_ints_ctrs[] = "spts_ints_ctrs";
...
static PyObject *__pyx_n_s_spts_ints_ctrs;
static PyObject *__pyx_n_s_spts_lbls;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_n_s_where;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_20MatureNascentUtility_MatureNascentUtility(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_spts_lbls, PyArrayObject *__pyx_v_spts_ints_ctrs); /* proto */
...
static PyObject *__pyx_pw_20MatureNascentUtility_1MatureNascentUtility(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_20MatureNascentUtility_MatureNascentUtility(PyArrayObject *__pyx_v_spts_lbls, PyArrayObject *__pyx_v_spts_ints_ctrs, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_zlen;
  int __pyx_v_xlen;
  int __pyx_v_ylen;
  CYTHON_UNUSED int __pyx_v_nlbs;
  PyArrayObject *__pyx_v_mtx2thr = 0;
  int __pyx_v_z;
  int __pyx_v_x;
  int __pyx_v_y;
  PyObject *__pyx_v_k = NULL;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_spts_ints_ctrs;
  __Pyx_Buffer __pyx_pybuffer_spts_ints_ctrs;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_spts_lbls;
  __Pyx_Buffer __pyx_pybuffer_spts_lbls;
  ...
  __Pyx_RefNannySetupContext("MatureNascentUtility", 0);
  __pyx_pybuffer_spts_lbls.pybuffer.buf = NULL;
  __pyx_pybuffer_spts_lbls.refcount = 0;
  __pyx_pybuffernd_spts_lbls.data = NULL;
  __pyx_pybuffernd_spts_lbls.rcbuffer = &__pyx_pybuffer_spts_lbls;
  __pyx_pybuffer_spts_ints_ctrs.pybuffer.buf = NULL;
  __pyx_pybuffer_spts_ints_ctrs.refcount = 0;
  __pyx_pybuffernd_spts_ints_ctrs.data = NULL;
  __pyx_pybuffernd_spts_ints_ctrs.rcbuffer = &__pyx_pybuffer_spts_ints_ctrs;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_spts_lbls.rcbuffer->pybuffer, (PyObject*)__pyx_v_spts_lbls, &__Pyx_TypeInfo_nn___pyx_t_20MatureNascentUtility_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) __PYX_ERR(0, 10, __pyx_L1_error)
  }
  __pyx_pybuffernd_spts_lbls.diminfo[0].strides = __pyx_pybuffernd_spts_lbls.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_spts_lbls.diminfo[0].shape = __pyx_pybuffernd_spts_lbls.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_spts_lbls.diminfo[1].strides = __pyx_pybuffernd_spts_lbls.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_spts_lbls.diminfo[1].shape = __pyx_pybuffernd_spts_lbls.rcbuffer->pybuffer.shape[1]; __pyx_pybuffernd_spts_lbls.diminfo[2].strides = __pyx_pybuffernd_spts_lbls.rcbuffer->pybuffer.strides[2]; __pyx_pybuffernd_spts_lbls.diminfo[2].shape = __pyx_pybuffernd_spts_lbls.rcbuffer->pybuffer.shape[2];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_spts_ints_ctrs.rcbuffer->pybuffer, (PyObject*)__pyx_v_spts_ints_ctrs, &__Pyx_TypeInfo_nn___pyx_t_20MatureNascentUtility_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 10, __pyx_L1_error)
  }
  __pyx_pybuffernd_spts_ints_ctrs.diminfo[0].strides = __pyx_pybuffernd_spts_ints_ctrs.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_spts_ints_ctrs.diminfo[0].shape = __pyx_pybuffernd_spts_ints_ctrs.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_spts_ints_ctrs.diminfo[1].strides = __pyx_pybuffernd_spts_ints_ctrs.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_spts_ints_ctrs.diminfo[1].shape = __pyx_pybuffernd_spts_ints_ctrs.rcbuffer->pybuffer.shape[1];

  /* "MatureNascentUtility.pyx":11
 * 
 * cpdef MatureNascentUtility(np.ndarray[DTYPE_t, ndim=3] spts_lbls, np.ndarray[DTYPE_t, ndim=2] spts_ints_ctrs):
 *     cdef int zlen = spts_lbls.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int xlen = spts_lbls.shape[1]
 ...
 */
  __pyx_v_zlen = (__pyx_v_spts_lbls->dimensions[0]);

  /* "MatureNascentUtility.pyx":12
 * cpdef MatureNascentUtility(np.ndarray[DTYPE_t, ndim=3] spts_lbls, np.ndarray[DTYPE_t, ndim=2] spts_ints_ctrs):
 *     cdef int zlen = spts_lbls.shape[0]
 *     cdef int xlen = spts_lbls.shape[1]             # <<<<<<<<<<<<<<
 *     cdef int ylen = spts_lbls.shape[2]
 ...
 */
  __pyx_v_xlen = (__pyx_v_spts_lbls->dimensions[1]);

  /* "MatureNascentUtility.pyx":13
 *     cdef int zlen = spts_lbls.shape[0]
 *     cdef int xlen = spts_lbls.shape[1]
 *     cdef int ylen = spts_lbls.shape[2]             # <<<<<<<<<<<<<<
 *     cdef int nlbs = spts_ints_ctrs.shape[1]
 ...
 */
  __pyx_v_ylen = (__pyx_v_spts_lbls->dimensions[2]);

  /* "MatureNascentUtility.pyx":14
 *     cdef int xlen = spts_lbls.shape[1]
 *     cdef int ylen = spts_lbls.shape[2]
 *     cdef int nlbs = spts_ints_ctrs.shape[1]             # <<<<<<<<<<<<<<
 *     cdef np.ndarray mtx2thr = np.zeros([zlen, xlen, ylen], dtype=DTYPE)
 * 
 */
  __pyx_v_nlbs = (__pyx_v_spts_ints_ctrs->dimensions[1]);

  /* "MatureNascentUtility.pyx":15
 *     cdef int ylen = spts_lbls.shape[2]
 *     cdef int nlbs = spts_ints_ctrs.shape[1]
 *     cdef np.ndarray mtx2thr = np.zeros([zlen, xlen, ylen], dtype=DTYPE)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_zlen); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_xlen); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_ylen); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 15, __pyx_L1_error)
  ...
  __pyx_t_5 = 0;
  __pyx_t_5 = PyDict_New(); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_DTYPE); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_t_3) < 0) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_4, __pyx_t_5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __pyx_v_mtx2thr = ((PyArrayObject *)__pyx_t_3);
  __pyx_t_3 = 0;

  /* "MatureNascentUtility.pyx":18
 * 
 * 
 *     for z in range(zlen):             # <<<<<<<<<<<<<<
 *         print(z)
 *         for x in range(xlen):
 */
  __pyx_t_6 = __pyx_v_zlen;
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    __pyx_v_z = __pyx_t_7;

    /* "MatureNascentUtility.pyx":19
 * 
 *     for z in range(zlen):
 *         print(z)             # <<<<<<<<<<<<<<
 *         for x in range(xlen):
 *             for y in range(ylen):
 */
    __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_z); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 19, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    if (__Pyx_PrintOne(0, __pyx_t_3) < 0) __PYX_ERR(0, 19, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

    /* "MatureNascentUtility.pyx":20
 *     for z in range(zlen):
 *         print(z)
 *         for x in range(xlen):             # <<<<<<<<<<<<<<
 *             for y in range(ylen):
 ...
 */
        ...
        __pyx_t_15 = -1;
        if (__pyx_t_12 < 0) {
          __pyx_t_12 += __pyx_pybuffernd_spts_lbls.diminfo[0].shape;
          if (unlikely(__pyx_t_12 < 0)) __pyx_t_15 = 0;
        } else if (unlikely(__pyx_t_12 >= __pyx_pybuffernd_spts_lbls.diminfo[0].shape)) __pyx_t_15 = 0;
        if (__pyx_t_13 < 0) {
          __pyx_t_13 += __pyx_pybuffernd_spts_lbls.diminfo[1].shape;
          if (unlikely(__pyx_t_13 < 0)) __pyx_t_15 = 1;
        } else if (unlikely(__pyx_t_13 >= __pyx_pybuffernd_spts_lbls.diminfo[1].shape)) __pyx_t_15 = 1;
        if (__pyx_t_14 < 0) {
          __pyx_t_14 += __pyx_pybuffernd_spts_lbls.diminfo[2].shape;
          if (unlikely(__pyx_t_14 < 0)) __pyx_t_15 = 2;
        } else if (unlikely(__pyx_t_14 >= __pyx_pybuffernd_spts_lbls.diminfo[2].shape)) __pyx_t_15 = 2;
        if (unlikely(__pyx_t_15 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_15);
          __PYX_ERR(0, 23, __pyx_L1_error)
        }
        __pyx_t_16 = (((*__Pyx_BufPtrStrided3d(__pyx_t_20MatureNascentUtility_DTYPE_t *, __pyx_pybuffernd_spts_lbls.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_spts_lbls.diminfo[0].strides, __pyx_t_13, __pyx_pybuffernd_spts_lbls.diminfo[1].strides, __pyx_t_14, __pyx_pybuffernd_spts_lbls.diminfo[2].strides)) != 0) != 0);
        if (__pyx_t_16) {

          /* "MatureNascentUtility.pyx":24
 *                 # print(spts_lbls[z, x, y])
 *                 if spts_lbls[z, x, y] != 0:
 *                     k                 =  np.where(spts_ints_ctrs[0, :] == spts_lbls[z, x, y])             # <<<<<<<<<<<<<<
 *                     # print(k, z, x, y, spts_lbls[z, x, y])
 ...
 */
          ...
          __Pyx_GOTREF(__pyx_t_5);
          __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_where); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 24, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __pyx_t_5 = PyObject_GetItem(((PyObject *)__pyx_v_spts_ints_ctrs), __pyx_tuple__2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 24, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          ...
          __pyx_t_15 = -1;
          if (__pyx_t_17 < 0) {
            __pyx_t_17 += __pyx_pybuffernd_spts_lbls.diminfo[0].shape;
            if (unlikely(__pyx_t_17 < 0)) __pyx_t_15 = 0;
          } else if (unlikely(__pyx_t_17 >= __pyx_pybuffernd_spts_lbls.diminfo[0].shape)) __pyx_t_15 = 0;
          if (__pyx_t_18 < 0) {
            __pyx_t_18 += __pyx_pybuffernd_spts_lbls.diminfo[1].shape;
            if (unlikely(__pyx_t_18 < 0)) __pyx_t_15 = 1;
          } else if (unlikely(__pyx_t_18 >= __pyx_pybuffernd_spts_lbls.diminfo[1].shape)) __pyx_t_15 = 1;
          if (__pyx_t_19 < 0) {
            __pyx_t_19 += __pyx_pybuffernd_spts_lbls.diminfo[2].shape;
            if (unlikely(__pyx_t_19 < 0)) __pyx_t_15 = 2;
          } else if (unlikely(__pyx_t_19 >= __pyx_pybuffernd_spts_lbls.diminfo[2].shape)) __pyx_t_15 = 2;
          if (unlikely(__pyx_t_15 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_15);
            __PYX_ERR(0, 24, __pyx_L1_error)
          }
          __pyx_t_2 = __Pyx_PyInt_From_npy_int32((*__Pyx_BufPtrStrided3d(__pyx_t_20MatureNascentUtility_DTYPE_t *, __pyx_pybuffernd_spts_lbls.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_spts_lbls.diminfo[0].strides, __pyx_t_18, __pyx_pybuffernd_spts_lbls.diminfo[1].strides, __pyx_t_19, __pyx_pybuffernd_spts_lbls.diminfo[2].strides))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 24, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_2);
          __pyx_t_1 = PyObject_RichCompare(__pyx_t_5, __pyx_t_2, Py_EQ); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 24, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __pyx_t_2 = NULL;
          ...
          if (!__pyx_t_2) {
            ...
            #endif
            {
              ...
              __pyx_t_1 = 0;
              __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_5, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 24, __pyx_L1_error)
              __Pyx_GOTREF(__pyx_t_3);
              __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
            }
          }
 ...
 *     return mtx2thr
 */
          __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_k, 0, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 0, 1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 26, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_3);
          __pyx_t_4 = __Pyx_GetItemInt(__pyx_t_3, 0, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 0, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 26, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
          ...
          __pyx_t_4 = 0;
          __pyx_t_4 = PyObject_GetItem(((PyObject *)__pyx_v_spts_ints_ctrs), __pyx_t_3); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 26, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_4);
          __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
          __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_z); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 26, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_3);
          __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_x); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 26, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_5);
          ...
          __pyx_t_5 = 0;
          __pyx_t_1 = 0;
          if (unlikely(PyObject_SetItem(((PyObject *)__pyx_v_mtx2thr), __pyx_t_2, __pyx_t_4) < 0)) __PYX_ERR(0, 26, __pyx_L1_error)
          __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
          __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 */
  ...
  __Pyx_INCREF(((PyObject *)__pyx_v_mtx2thr));
  __pyx_r = ((PyObject *)__pyx_v_mtx2thr);
  goto __pyx_L0;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_spts_ints_ctrs.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_spts_lbls.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("MatureNascentUtility.MatureNascentUtility", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_spts_ints_ctrs.rcbuffer->pybuffer);
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_spts_lbls.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_mtx2thr);
...
/* Python wrapper */
static PyObject *__pyx_pw_20MatureNascentUtility_1MatureNascentUtility(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_20MatureNascentUtility_1MatureNascentUtility(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_spts_lbls = 0;
  PyArrayObject *__pyx_v_spts_ints_ctrs = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("MatureNascentUtility (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_spts_lbls,&__pyx_n_s_spts_ints_ctrs,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_spts_lbls)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_spts_ints_ctrs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("MatureNascentUtility", 1, 2, 2, 1); __PYX_ERR(0, 10, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "MatureNascentUtility") < 0)) __PYX_ERR(0, 10, __pyx_L3_error)
      }
    ...
    __pyx_v_spts_lbls = ((PyArrayObject *)values[0]);
    __pyx_v_spts_ints_ctrs = ((PyArrayObject *)values[1]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("MatureNascentUtility", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("MatureNascentUtility.MatureNascentUtility", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_spts_lbls), __pyx_ptype_5numpy_ndarray, 1, "spts_lbls", 0))) __PYX_ERR(0, 10, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_spts_ints_ctrs), __pyx_ptype_5numpy_ndarray, 1, "spts_ints_ctrs", 0))) __PYX_ERR(0, 10, __pyx_L1_error)
  __pyx_r = __pyx_pf_20MatureNascentUtility_MatureNascentUtility(__pyx_self, __pyx_v_spts_lbls, __pyx_v_spts_ints_ctrs);
...
static PyObject *__pyx_pf_20MatureNascentUtility_MatureNascentUtility(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_spts_lbls, PyArrayObject *__pyx_v_spts_ints_ctrs) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_spts_ints_ctrs;
  __Pyx_Buffer __pyx_pybuffer_spts_ints_ctrs;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_spts_lbls;
  __Pyx_Buffer __pyx_pybuffer_spts_lbls;
  ...
  __pyx_pybuffernd_spts_ints_ctrs.diminfo[0].strides = __pyx_pybuffernd_spts_ints_ctrs.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_spts_ints_ctrs.diminfo[0].shape = __pyx_pybuffernd_spts_ints_ctrs.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_spts_ints_ctrs.diminfo[1].strides = __pyx_pybuffernd_spts_ints_ctrs.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_spts_ints_ctrs.diminfo[1].shape = __pyx_pybuffernd_spts_ints_ctrs.rcbuffer->pybuffer.shape[1];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_20MatureNascentUtility_MatureNascentUtility(__pyx_v_spts_lbls, __pyx_v_spts_ints_ctrs, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {"MatureNascentUtility", (PyCFunction)__pyx_pw_20MatureNascentUtility_1MatureNascentUtility, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_spts_ints_ctrs, __pyx_k_spts_ints_ctrs, sizeof(__pyx_k_spts_ints_ctrs), 0, 0, 1, 1},
  {&__pyx_n_s_spts_lbls, __pyx_k_spts_lbls, sizeof(__pyx_k_spts_lbls), 0, 0, 1, 1},
 ...
 */
  ...
  __pyx_tuple__2 = PyTuple_Pack(2, __pyx_int_0, __pyx_slice_); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 24, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initMatureNascentUtility(void); /*proto*/
PyMODINIT_FUNC initMatureNascentUtility(void)
#else
PyMODINIT_FUNC PyInit_MatureNascentUtility(void); /*proto*/
PyMODINIT_FUNC PyInit_MatureNascentUtility(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_MatureNascentUtility(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("MatureNascentUtility", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_MatureNascentUtility) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "MatureNascentUtility")) {
      if (unlikely(PyDict_SetItemString(modules, "MatureNascentUtility", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init MatureNascentUtility", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init MatureNascentUtility");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
